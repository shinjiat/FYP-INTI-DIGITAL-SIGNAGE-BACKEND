...
<body>
	...
	<div id="imagemap4posis">
		...
		<div id="mapContainer" class="effect" width="500px">
			<?php
				$attr = '';
			...
			?>
			<img src="<?php echo ($uploaded) ? $_SESSION['image'][0] : '#'; ?>"<?php echo $attr; ?> id="main" class="imgmapMainImage" alt="" usemap="#map"  width="1200px"/>
		...
		<div class="form">
			...
			<input id="coordsText"name="coordsText" type="text" value="" placeholder="&laquo; Coordinates &raquo;" />
			<input id="name" name="name" type="text" value="" placeholder="Map Name" />
			<input id="mapid"  name="mapid" type="text" value="" placeholder="MapID" />
			<input id="submit" type="submit" class="effect textareaButton3" name="submit" value="submit"/>
